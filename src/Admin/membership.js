    ...
    return (
      ...
      <div className="dash wrapper flex items-stretch w-full h-screen bg-light">
                  ...
                  <g transform="translate(-1184.523 -81.41)">
                    ...
                    <path id="Path_2221" data-name="Path 2221" d="M1333.732,227.341a3.352,3.352,0,0,1-6.7-.054,3.352,3.352,0,1,1,6.7.054Zm-2.727.841c0-.283.009-.567,0-.85a.6.6,0,0,0-.6-.616.581.581,0,0,0-.631.578c-.021.577-.022,1.157,0,1.734a.579.579,0,0,0,.643.563A.6.6,0,0,0,1331,229C1331.016,228.726,1331.005,228.454,1331.006,228.182Zm0-2.52c0-.511-.116-.632-.613-.635-.517,0-.651.13-.647.644,0,.49.14.621.638.619S1331.005,226.165,1331.005,225.662Z" transform="translate(-132.372 -132.412)" fill="#fff"/>
	                  ...
	                  <g transform="translate(-2.249 -3.375)">
						...
						<li className="min-h-42">
							<NavLink to='/Admin/Membership' className="active leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
        ...
        <div className="pl-3 lg:pt-4 lg:pb-4 py-2.5 mb-3 relative z-50">
            ...
            <div className='bg-white rounded-lg shadow m-4 p-5'>

                <div className='md:flex items-center justify-between mb-4'>
                    <div className='text-xl text-black font-bold'>Membership</div> 
                    <div>
                        <a className='flex items-center bg-theme rounded-l-full py-2 px-2' href="#" onClick={() => setCreateMembershipModal(true)}>
                ...
                <div className="bg-stone-100 rounded-lg shadow p-4 mb-4">
                    <div className="md:flex items-center justify-between">
                        <div>
                            <svg className="inline-flex mr-2" xmlns="http://www.w3.org/2000/svg" width="14.889" height="18.469" viewBox="0 0 14.889 18.469">
                            ...
                            <h4 className="inline-flex text-lg text-theme font-semibold md:mb-0 mb-2">Platinum Mambership</h4> 
                        </div>
                        <div>
                            <a href="#" className="inline-flex bg-white rounded-full p-4 mr-2">
                            ...
                            <a href="#" className='inline-flex bg-white rounded-full p-4'>
                    ...
                    <div className="md:flex w-full">
                        <div className="md:w-2/5">
                            <ul className="md:ml-5">
                                <li className="mb-2"><b>Plan :</b> Monday to Friday (6 AM to 4 PM)</li>
                                <li className="mb-2"><b>Subscription Amount :</b> 35 CAD</li>
                                <li className="mb-2"><b>Plan for :</b> Signal Adult</li>
                                <li className="mb-2"><b>Bird :</b> Evening Bird</li>
                                <li className="mb-2"><b>Plan for :</b> Signal Adult</li>
                            </ul>
                        </div>
                        <div className="md:w-3/5">
                            <ul>
                                <li className="mb-2"><b>Facility :</b>  Racket, shuttlecock, court, posts and the net.</li>
                                <li className="mb-2"><b>Description :</b> </li>
                                <li className="mb-2">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est. Lorem ipsum dolor sit amet.
consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. </li>
                            </ul>
                        </div>
                    </div>
                    </div>
            ...
            >
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="grid gap-4">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Membership Title*</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="Enter Membership Title" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>
                        </div>
                        <div className="md:grid md:gap-4 md:grid-cols-2">
                            <div>
                                <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Days*</label>
                                <div className="relative flex w-full flex-wrap items-stretch">
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                    <option value="no">Select Week Day</option>
                            ...
                            <div>
                                <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Time Duration*</label>
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                    <option value="no">Select Dration</option>
                                    <option value="tag1">Tag 1</option>
                                    <option value="tag2">Tag 2</option>
                                </select>
                            </div>
                        ...
                        <div className="md:grid md:gap-4 md:grid-cols-2">
                            ...
                            <div>
                                <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Bird*</label>
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                        ...
                        <div className="md:grid md:gap-4 md:grid-cols-2">
                            <div>
                                <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Select Plan Duration*</label>
                            ...
                            <div>
                                <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Plan For*</label>
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                        ...
                        <div>
                            <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Facility* </label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                    ...
                    <div className="flex flex-wrap items-center pt-0 p-6 rounded-b">
                        ...
                        <button
                            ...
                            type="button" onClick={() => setCreateMembershipModal(false)}>
                            Cancel
                        </button>                  
                    </div>
                </div>
