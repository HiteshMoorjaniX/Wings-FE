...
export default function Booking5() {
    ...
    //Modal
    const [currentFrom, setCurrentFrom] = useState('all')
    const changeFrom = (newFrom) => {
        setCurrentFrom(newFrom)
    }
    const [currentTo, setCurrentTo] = useState('all')
    const changeTo = (newTo) => {
        setCurrentTo(newTo)
    }
    const [currentSp, setCurrentSp] = useState('all')
    const changeSp = (newSp) => {
        setCurrentSp(newSp)
    }
    const [currentHolder, setCurrentHolder] = useState('all')
    const changeHolder = (newHolder) => {
        setCurrentHolder(newHolder)
    }
    const [currentPStatus, setCurrentPStatus] = useState('all')
    const changePStatus = (newPStatus) => {
        setCurrentPStatus(newPStatus)
    }
    //Modal
			...
			<div className="dash wrapper flex items-stretch w-full h-screen bg-light">
				<nav id="sidebar" className={`h-full max-w-182 lg:max-w-260 w-full z-10 ${navbar ? "block w-full Fullmenu absolute md:relative" : "md:w-14 w-0 overflow-hidden  Iconmenu"}`}>
                  ...
                  <path d="M4.532,6.063H3V16.785a1.536,1.536,0,0,0,1.532,1.532H15.254V16.785H4.532ZM16.785,3H7.6A1.536,1.536,0,0,0,6.063,4.532v9.19A1.536,1.536,0,0,0,7.6,15.254h9.19a1.536,1.536,0,0,0,1.532-1.532V4.532A1.536,1.536,0,0,0,16.785,3Zm-.766,6.893H8.361V8.361h7.659Zm-3.063,3.063h-4.6V11.424h4.6Zm3.063-6.127H8.361V5.3h7.659Z" transform="translate(-3 -3)" fill="#fff"/>
						...
						<li className="min-h-42">
							<NavLink  to='/Admin/Booking5' className="active leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
                ...
                <div className='flex items-center justify-between'>
                  <div className='text-xl text-black font-bold'>Set Availability</div>
                    <div>
  ...
  <path id="Path_4757" data-name="Path 4757" d="M874.474-48.353l-.123-.058a.743.743,0,0,1-.469-.7c-.008-.776-.013-1.551,0-2.327a1.131,1.131,0,0,1,1.131-1.111c.25-.009.5-.014.751,0a.291.291,0,0,0,.339-.224c.49-1.268.995-2.529,1.491-3.795a.8.8,0,0,1,.568-.543,1.07,1.07,0,0,1,.248-.023q4.636,0,9.271,0a.786.786,0,0,1,.8.538c.507,1.286,1.018,2.571,1.521,3.859.054.137.117.2.27.189.244-.013.489-.005.734,0a1.149,1.149,0,0,1,1.2,1.2c0,.692-.007,1.384,0,2.076a.838.838,0,0,1-.6.909c.017.059.029.114.048.167l2.553,7.024a1.811,1.811,0,0,1,.1.323.756.756,0,0,1-.79.9q-2.926,0-5.853,0-7.517,0-15.034,0a1.147,1.147,0,0,1-.483-.092.755.755,0,0,1-.337-1.012q.494-1.361.991-2.722.789-2.167,1.577-4.335C874.423-48.19,874.447-48.268,874.474-48.353Zm8.554-.764q4.107,0,8.214,0c.157,0,.217-.032.214-.205-.011-.65,0-1.3,0-1.95,0-.39-.125-.517-.513-.518H875.173c-.412,0-.531.12-.531.535q0,.949,0,1.9c0,.239,0,.239.244.239Zm7.139,8.4c-.01-.056-.012-.085-.019-.113-.222-.8-.447-1.595-.664-2.395-.036-.132-.1-.16-.228-.16q-6.21,0-12.42,0a.2.2,0,0,0-.231.179c-.156.581-.322,1.16-.483,1.74-.068.244-.132.489-.2.749Zm-7.515-3.443c0-.065.01-.118.01-.17,0-1.277,0-2.554,0-3.83,0-.149-.047-.192-.194-.191q-2.13.007-4.26,0c-.138,0-.183.054-.216.173-.28,1.011-.564,2.021-.846,3.031-.09.325-.178.65-.27.989Zm6.555,0c-.016-.077-.026-.135-.041-.191q-.535-1.921-1.069-3.841a.191.191,0,0,0-.224-.163q-2.112.007-4.224,0c-.171,0-.223.045-.222.219q.01,1.888,0,3.776c0,.18.06.215.225.214,1.784-.005,3.568,0,5.352,0C889.066-44.151,889.129-44.157,889.207-44.162Zm-11.964-4.192h-.206c-.513,0-1.026.006-1.539,0a.238.238,0,0,0-.272.185q-1.322,3.657-2.652,7.31c-.015.042-.022.087-.035.139a.88.88,0,0,0,.1.013c.781,0,1.563,0,2.344,0,.134,0,.155-.076.181-.171l1.917-6.87C877.137-47.941,877.185-48.135,877.242-48.354Zm16.33,7.632-.59-1.625q-1.053-2.9-2.1-5.8a.269.269,0,0,0-.307-.214c-.489.013-.978,0-1.467,0h-.25c.019.084.029.141.045.2q1.014,3.642,2.026,7.286a.191.191,0,0,0,.224.164c.746-.007,1.492,0,2.237,0C893.439-40.711,893.491-40.716,893.572-40.721Zm-7.448-14.517c-.091-.335-.183-.648-.261-.965-.033-.135-.1-.174-.237-.172-.608.008-1.216,0-1.824,0-1.115,0-2.23,0-3.344,0-.063,0-.17.023-.181.059-.111.349-.206.7-.31,1.073Zm.73,2.675a.576.576,0,0,0-.006-.092c-.156-.562-.316-1.124-.469-1.688-.03-.11-.1-.114-.187-.114-.865,0-1.729,0-2.594,0-.137,0-.172.046-.17.176.006.507.008,1.014,0,1.521,0,.163.043.214.211.213,1.014-.007,2.027,0,3.042,0C886.731-52.554,886.784-52.56,886.854-52.564Zm-7.619-.009a1.138,1.138,0,0,0,.14.018c1.043,0,2.086,0,3.129,0,.128,0,.163-.049.161-.169,0-.513-.008-1.025,0-1.538,0-.156-.04-.2-.2-.2q-1.269.012-2.539,0a.2.2,0,0,0-.232.177c-.128.483-.268.964-.4,1.446C879.271-52.754,879.256-52.668,879.235-52.573Zm10.015,0-.474-1.2c-.319-.809-.637-1.618-.96-2.425-.026-.064-.086-.159-.134-.161-.348-.014-.7-.007-1.05-.007a.437.437,0,0,0,0,.1q.5,1.8,1,3.6a.152.152,0,0,0,.177.127c.429,0,.858,0,1.287,0A1.462,1.462,0,0,0,889.25-52.575Zm-12.408.009c.093.005.156.012.219.012.387,0,.775-.007,1.162,0a.217.217,0,0,0,.256-.193c.318-1.16.643-2.318.965-3.476a1.548,1.548,0,0,0,.024-.154c-.321,0-.624.008-.926,0a.241.241,0,0,0-.274.182c-.374.966-.756,1.929-1.136,2.893Z" transform="translate(-871.759 57.136)" fill="#fff"/>
                ...
                <form>
                  <div className="grid gap-4">
                      <div className="grid gap-4 grid-cols-3">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Date & Time</label>
                            <select onChange={(event) => changeSpace(event.target.value)} value={currentSpace} className='rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                                <option value="all">Thursday, November 2022</option>
                        ...
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">From</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                {/* <input type="text" placeholder="All Users Can See The Space" className="font-base h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/> */}
                                <select onChange={(event) => changeFrom(event.target.value)} value={currentFrom} className='w-full rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                        ...
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">To</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                {/* <input type="text" placeholder="All Users Can See The Space" className="font-base h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/> */}
                                <select onChange={(event) => changeTo(event.target.value)} value={currentTo} className='w-full rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                                    <option value="06">06:00</option>
                                    <option value="05">05:00</option>
                                </select>
                            </div>
                      ...
                      <div className="grid gap-4 grid-cols-2">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Spaces</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                ...
                                <select onChange={(event) => changeSp(event.target.value)} value={currentSp} className='w-full rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                                    <option value="co1">Court 1</option>
                                    <option value="co2">Court 2</option>
                                </select>
                            </div>
                        </div>
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Holder</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                {/* <input type="text" placeholder="All Users Can See The Space" className="font-base h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/> */}
                                <select onChange={(event) => changeHolder(event.target.value)} value={currentHolder} className='w-full rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                                    <option value="casualuser">Casual User (no details needed)</option>
                                    <option value="casualuser2">Casual User 2</option>
                                </select>
                            </div>
                        </div>
                      </div>
                      <div className="grid gap-4 grid-cols-2">
                        ...
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Payment Status</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                {/* <input type="text" placeholder="All Users Can See The Space" className="font-base h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/> */}
                                <select onChange={(event) => changePStatus(event.target.value)} value={currentPStatus} className='w-full rounded-lg border-2 border-stone-200 h-12px-3 py-2'>
                      ...
                      <div>
                          <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Booking Title</label>
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <input type="text" placeholder="An Optional Booking Summary" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                          </div>
                      </div>                      
                      <div>
                          <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Notes</label>
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <input type="text" placeholder="Any Further Infomation" className="h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-gray-400 hover:border-theme focus:border-theme"/>
                ...
                <div className="flex items-center  p-6 border-t border-solid border-slate-200 rounded-b">
                    <button
                        className="bg-theme text-white active:bg-emerald-600 font-bold text-sm px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        onClick={() => setShowModal(false)}
                    >
                        Confirm Booking
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-black"></div>
                ...
                <table className="table-auto w-full rounded-lg border-collapse p-4 mt-4">
                    <thead>
                        <tr className='text-left bg-neutral-200'>
                            <th className='py-3 px-2 mb-4'>Spaces</th>
                            <th>Day</th>
                            <th>Timings</th>
                            <th>Price</th>
                            <th>Working Day</th>
                    ...
                    <tbody>
                        ...
                        <td className='py-5 px-2 relative'>
                            <select onChange={(event) => changeSpace(event.target.value)} value={currentSpace} className='rounded-lg bg-lgtheme px-3 py-2'>
                        ...
                        <td>
                            <span className='inline-flex items-center border-2 border-theme rounded-lg px-3 py-2 mx-3'>
                                <span className='ml-2 font-semibold'>CAD $30/h</span>
                            </span> 
                        </td>
                        <td>Close Open
                ...
                <div className='bg-neutral-200 rounded-lg p-4 mt-7'>
                    <div className='text-xl text-black font-bold'>Scheduler Display Hours</div>
                    <div className='flex items-center'>
                        <p className=''>Show the hours on the scheduler time axis</p>
                            <span className='inline-flex items-center border-2 border-gray-400 rounded-lg px-3 py-2 mx-3'>
                                <svg id="Icon_ionic-md-time" data-name="Icon ionic-md-time" xmlns="http://www.w3.org/2000/svg" width="13.948" height="13.948" viewBox="0 0 13.948 13.948">
                                    <path id="Path_4638" data-name="Path 4638" d="M10.342,3.375a6.974,6.974,0,1,0,6.981,6.974A6.971,6.971,0,0,0,10.342,3.375Zm.007,12.553a5.579,5.579,0,1,1,5.579-5.579A5.579,5.579,0,0,1,10.349,15.928Z" transform="translate(-3.375 -3.375)" fill="#ff6a00"/>
                                    <path id="Path_4639" data-name="Path 4639" d="M17.584,10.688H16.537v4.184l3.661,2.2.523-.858-3.138-1.861Z" transform="translate(-10.261 -7.201)" fill="#ff6a00"/>
                                </svg><span className='ml-2'>06:00AM</span>
                        ...
                        <a href='#' className='bg-theme text-white rounded-lg py-2 px-4 min-w-110 flex justify-center'>Save </a>
                    </div>
                </div>
            </div> 
