...
export default function Booking10() {
  ...
  const [showTagsModal, setTagsModal] = useState(false);
      ...
      <div className="dash wrapper flex items-stretch w-full h-screen bg-light">
        <nav id="sidebar" className={`h-full max-w-182 lg:max-w-260 w-full z-10 ${navbar ? "block w-full Fullmenu absolute md:relative" : "md:w-14 w-0 overflow-hidden  Iconmenu"}`}>
                  ...
                  <path d="M4.532,6.063H3V16.785a1.536,1.536,0,0,0,1.532,1.532H15.254V16.785H4.532ZM16.785,3H7.6A1.536,1.536,0,0,0,6.063,4.532v9.19A1.536,1.536,0,0,0,7.6,15.254h9.19a1.536,1.536,0,0,0,1.532-1.532V4.532A1.536,1.536,0,0,0,16.785,3Zm-.766,6.893H8.361V8.361h7.659Zm-3.063,3.063h-4.6V11.424h4.6Zm3.063-6.127H8.361V5.3h7.659Z" transform="translate(-3 -3)" fill="#fff"/>
						...
						<li className="min-h-42">
							<NavLink to='/Admin/Booking10' className="active leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
        ...
        <div className="pl-3 lg:pt-4 lg:pb-4 py-2.5 mb-3 relative z-50">
            ...
            <div className='bg-white rounded-lg m-4 p-5'>
                ...
                <div className='flex items-center justify-between mb-4'>
                    <div className='text-xl text-black font-bold'>Booking User List</div>                    
                </div>
                <div>
                <div className="md:flex items-center justify-between">
                    <div>                        
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <input type="text" placeholder="Search..." className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-full border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewBox="0 0 31 31">
                                <g transform="translate(0.238)">
                                    <circle id="NoPath" cx="15.5" cy="15.5" r="15.5" transform="translate(-0.238)" fill="#222"/>
                                    <path id="Icon_awesome-search" data-name="Icon awesome-search" d="M13.574,11.9l-2.68-2.68a.645.645,0,0,0-.457-.188H10A5.588,5.588,0,1,0,9.032,10v.438a.645.645,0,0,0,.188.457l2.68,2.68a.642.642,0,0,0,.911,0l.761-.761a.648.648,0,0,0,0-.914ZM5.591,9.032A3.441,3.441,0,1,1,9.032,5.591,3.439,3.439,0,0,1,5.591,9.032Z" transform="translate(8.619 8.618)" fill="#fff"/>
                                </g>
                            </svg>
                            </span>
                          </div>
                    ...
                    <div>
                        <a className='inline-flex items-center bg-gray-100 rounded-l-full rounded-r-lg py-2 px-2 ml-4' href="#" onClick={() => setInviteModal(true)}>
                            <div className='flex bg-theme rounded-full p-2 mr-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.738" height="11.738" viewBox="0 0 11.738 11.738">
                                    <g id="Icon_feather-send" data-name="Icon feather-send" transform="translate(-2.5 -2.293)">
                                        <path id="Path_13201" data-name="Path 13201" d="M22.292,3,16.5,8.792" transform="translate(-8.761 0)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
                                        <path id="Path_13202" data-name="Path 13202" d="M13.531,3,9.845,13.531,7.739,8.792,3,6.686Z" transform="translate(0 0)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
                                    </g>
                                </svg>
                            </div>
                            <div className='text-base text-black'>Send Invite Link</div>
                        </a>
                        <a className='inline-flex items-center bg-gray-100 rounded-l-full rounded-r-lg py-2 px-2 ml-4' href="#" onClick={() => setNewUserModal(true)}>
                            <div className='flex bg-theme rounded-full p-2 mr-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="9.382" height="11.952" viewBox="0 0 9.382 11.952">
                                    <g id="Icon_feather-user" data-name="Icon feather-user" transform="translate(-5.5 -4)">
                                        <path id="Path_13203" data-name="Path 13203" d="M14.382,27.166V24.6a2.1,2.1,0,0,0-2.1-2.1H8.1A2.1,2.1,0,0,0,6,24.6v2.57" transform="translate(0 -11.713)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
                                        <path id="Path_13204" data-name="Path 13204" d="M16.191,6.6a2.1,2.1,0,1,1-2.1-2.1A2.1,2.1,0,0,1,16.191,6.6Z" transform="translate(-3.904)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
                                    </g>
                                </svg>
                            </div>
                            <div className='text-base text-black'>Add New User</div>
                        </a>
                        <a className='inline-flex items-center bg-gray-100 rounded-l-full rounded-r-lg py-2 px-2 ml-4' href="#" onClick={() => setTagsModal(true)}>
                            <div className='flex bg-theme rounded-full p-2 mr-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="10.212" height="10.123" viewBox="0 0 10.212 10.123">
                                <g id="Icon_feather-tag" data-name="Icon feather-tag" transform="translate(-2.5 -2.5)">
                                    <path id="Path_13205" data-name="Path 13205" d="M11.849,8.431,8.436,11.844a.952.952,0,0,1-1.347,0L3,7.76V3H7.76l4.089,4.089A.952.952,0,0,1,11.849,8.431Z" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"/>
                                </g>
                                </svg>
                            </div>
                            <div className='text-base text-black'>Manage Tags</div>
                        </a>
                        <a className='inline-flex items-center bg-gray-100 rounded-l-full rounded-r-lg py-2 px-2 ml-4' href="#" onClick={() => setExportModal(true)}>
                            <div className='flex bg-theme rounded-full p-2 mr-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="10.294" height="13.235" viewBox="0 0 10.294 13.235">
                                <path id="Icon_material-import-export" data-name="Icon material-import-export" d="M10.441,4.5,7.5,7.434H9.706v5.154h1.471V7.434h2.206Zm5.147,10.3V9.647H14.118V14.8H11.912l2.941,2.934L17.794,14.8Z" transform="translate(-7.5 -4.5)" fill="#fff"/>
                                </svg>
                            </div>
                ...
                <table className="table-auto w-full rounded-lg border-collapse p-4 mt-4 mb-8">
                    ...
                    <tbody>
                        <tr>
                            <td className='py-5 px-2'>Samarth</td>
                            <td>Kundagol</td>
                            <td>Kole</td>
                            <td>arun.karikatti@symbol.org</td>
                            <td>0932380757</td>
                            <td>Owner</td>
                            <td>
                                <a href="#" className="inline-flex bg-orange-100 rounded-full p-4 mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 13.585 13.105">
                                    <g id="Icon_feather-edit-3" data-name="Icon feather-edit-3" transform="translate(0.6 0.725)">
                                        <path id="Path_13167" data-name="Path 13167" d="M18,30h6.192" transform="translate(-11.808 -18.22)" fill="none" stroke="#ff6a00" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"/>
                                        <path id="Path_13168" data-name="Path 13168" d="M13.789,4.746A1.46,1.46,0,0,1,15.853,6.81l-8.6,8.6L4.5,16.1l.688-2.752Z" transform="translate(-4.5 -4.318)" fill="none" stroke="#ff6a00" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"/>
                                    </g>
                                    </svg>
                                </a>
                                <a href="#" className="inline-flex bg-neutral-200 rounded-full p-4 mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 17 3">
                                    <g id="Group_2775" data-name="Group 2775" transform="translate(-8.5 -15.5)">
                                        <circle id="Ellipse_457" data-name="Ellipse 457" cx="1.5" cy="1.5" r="1.5" transform="translate(8.5 15.5)" fill="#222"/>
                                        <circle id="Ellipse_458" data-name="Ellipse 458" cx="1.5" cy="1.5" r="1.5" transform="translate(15.5 15.5)" fill="#222"/>
                                        <circle id="Ellipse_459" data-name="Ellipse 459" cx="1.5" cy="1.5" r="1.5" transform="translate(22.5 15.5)" fill="#222"/>
                                    </g>
                                    </svg>
                                </a>
                            </td>
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <form>
                  <div className="grid gap-4">
                      <div>
                          <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Email ID</label>
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <input type="text" placeholder="user@email.com" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                          </div>
                      </div>
                      <div className="grid gap-4 grid-cols-2">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">First Name</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="First name" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>
                        </div>
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Last Name</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="Last name" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>
                        </div>
                      </div>
                      <div className="grid gap-4 grid-cols-2">
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Phone</label>
                            <div className="relative flex flex-wrap w-full items-stretch">
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='inline-flex border-2 border-stone-200 rounded-lg px-3 py-2'>
                                    <option value="all">(CA)</option>
                                    <option value="sun">Sun</option>
                                    <option value="mon">Mon</option>
                                </select>	
                                <input type="text" placeholder="(778) 881 - 1132" className="inline-flex font-normal h-12 px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>
                        </div>
                        <div>
                            <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Organization</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="(Optional)" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>
                        </div>
                      </div>
                      <div>
                          <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">System Tag</label>
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                  <option value="allusers">No System tag</option>
                      ...
                      <div>
                          <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Custom Tags</label>
                          <div className="relative flex w-full flex-wrap items-stretch">
                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                  <option value="no">No Tags Selected</option>
                                  <option value="tag1">Tag 1</option>
                                  <option value="tag2">Tag 2</option>
                            </select>
                          </div>                          
                    ...
                    <div className="flex items-center mt-3">
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 20.547 20.547">
                            <g id="Icon_feather-info" data-name="Icon feather-info" transform="translate(-2.25 -2.25)">
                                <path id="Path_13206" data-name="Path 13206" d="M22.047,12.523A9.523,9.523,0,1,1,12.523,3,9.523,9.523,0,0,1,22.047,12.523Z" fill="none" stroke="#7d7d7d" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                                <path id="Path_13207" data-name="Path 13207" d="M18,21.809V18" transform="translate(-5.477 -5.477)" fill="none" stroke="#7d7d7d" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                                <path id="Path_13208" data-name="Path 13208" d="M18,12h0" transform="translate(-5.477 -3.286)" fill="none" stroke="#7d7d7d" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                            </g>
                        </svg>
                        </div>
                        <div className="ml-2">
                        <p className="text-xs">This New User Will Be Sent An Invitation Email</p>
                        <p className="text-xs">(In Accordance With Your Venue's Notification Settings).</p>
                        </div>
                    </div>
                  </form>
                </div>
          ...
          <div className="opacity-25 fixed inset-0 z-40 bg-black"></div>
            ...
            >
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <form>
                        <div>
                        Share this link to let your users easily add them selves.any tags you
choose will automatically be applied.
                        </div>
                    <div className="grid gap-4 mt-3">
                        
                       
                        <div>
                            <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Select Tags</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                    <option value="allusers">No System tag</option>
                                    <option value="tag1">Tag 1</option>
                        ...
                        <div>
                            <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Share Link</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-full rounded-lg border-2 border-stone-200 placeholder-gray-400 px-3 py-2'>
                                    <option value="no">No Tags Selected</option>
                                    <option value="tag1">Tag 1</option>
            ...
            >
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <form>
                        <div>
                        Here You Can Create Custom Tags To Give To Users. You Can Then 
Customize Many Of Wings Features Based On Them 
<p className="text-theme">(E.G. Access, Coloring, Pricing).</p>
                        </div>
                    <div className="grid gap-4 mt-3">
                        <div>
                            <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Add New Tag</label>
                            <div className="relative flex w-full flex-wrap items-stretch">
                                <input type="text" placeholder="New Tags" className="font-normal h-12 w-full px-3 outline-0 bg-transparent text-sec rounded-lg border-2 border-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                            </div>                          
                        </div>                      
                        </div>
                    ...
                    <div className="flex items-center pt-0 p-6 rounded-b">
                        ...
                        <button
                            className="min-w-130 bg-gray-200 text-black rounded-lg font-bold px-6 py-3 text-sm outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                            type="button" onClick={() => setTagsModal(false)}>
                            Cancel
                        </button>                  
                    </div>
                </div>
            ...
            >
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="flex items-center pt-0 p-6 rounded-b">
                        ...
                        <button
                            className="min-w-130 bg-gray-200 text-black rounded-lg font-bold px-6 py-3 text-sm outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                            type="button" onClick={() => setExportModal(false)}>
                            Cancel
                        </button>                  
                    </div>
                </div>
