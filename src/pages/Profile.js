...
export default function Profile() {
  ...
  return(
      <div className="dash wrapper flex items-stretch w-full h-screen bg-light">
        <nav id="sidebar" className={`h-full max-w-182 lg:max-w-260 w-full z-10 relative ${navbar ? "block w-full Fullmenu" : "md:w-14 w-0 overflow-hidden  Iconmenu"}`}>
          ...
          <ul className={`h-12 ${navbar ? "block" : "hidden"}`} className="sideNav b-5 text-white gap-y-2 bg-sec h-full fixed rounded-tr-3xl pt-4 flex flex-col gap-y-2 z-50">
          <li className="min-h-58">
            ...
            <li className="min-h-42">
              <NavLink to='/Profile' className="active md:absolute leading-4 md:bottom-22 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
         ...
         <div className="p-4">
            ...
            <div className="z-10">
                <div className="container-fluid">
                    <div className="flex flex-wrap items-center mb-3 lg:mb-2 shadow p-2">
                        <div className="flex items-center">   
                            ...
                            <div className="title-set">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 10.276 15.012" className="inline-flex md:mr-3 mr-1">
                                    <g id="Group_3614" data-name="Group 3614" transform="translate(-172.281 -169.525)">
                                        <path id="Path_5133" data-name="Path 5133" d="M1465.052,844.117a22.357,22.357,0,0,1-4.493-.454.691.691,0,0,1-.643-.8c.116-1.117.2-2.244.417-3.343a3.485,3.485,0,0,1,3.362-2.749c.809-.017,1.618-.007,2.427-.005a3.6,3.6,0,0,1,3.759,3.421c.086.858.193,1.713.3,2.569a.731.731,0,0,1-.633.9A21.827,21.827,0,0,1,1465.052,844.117Z" transform="translate(-1287.63 -659.581)" fill="#ff6a00"/>
                                        <path id="Path_5134" data-name="Path 5134" d="M1489.728,720.011a3.378,3.378,0,1,1-3.409,3.377A3.381,3.381,0,0,1,1489.728,720.011Z" transform="translate(-1312.306 -550.486)" fill="#ff6a00"/>
                                    </g>
                                </svg>
                                <span className="font-bold inline-flex md:text-lg text-base">My Info</span></h3>
                            </div>
                        </div>                        
                    </div>
                </div>
            ...
            <div className="py-2 ">
                <div className="container-fluid">
                    <div className="mb-3 lg:mb-2 shadow md:p-4 p-2"> 
                        <div className="md:flex mb-3 justify-between">                            
                            <div><h4 className="md:text-lg text-base md:mb-0 mb-2">Wallet Balance : <span className="text-theme font-semibold">CAD $56.00</span></h4>   </div>
                            <a className="bg-sec text-white rounded-full px-6 py-1">Edit</a>                       
                        </div>
                        <div className="md:flex items-center">
                            ...
                            <div className="lg:w-10/12 md:w-full md:px-4 px-0">
                                <div className="lg:flex lg:space-x-2 mb-4">
                                    ...
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Last Name</label>
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <input type="text" placeholder="Krishnamoorthy" className="h-12 w-full px-3 outline-0 text-sec rounded-lg bg-stone-200 placeholder-gray-400 hover:border-theme focus:border-theme"/>
                                        </div>
                                    </div>
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Date Of Birth</label>
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <input type="text" placeholder="07/01/1993" className="h-12 w-full px-3 outline-0 text-sec rounded-lg bg-stone-200 placeholder-gray-400 hover:border-theme focus:border-theme"/>
                                        </div>
                                    </div>
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        ...
                                        <div className="relative flex flex-wrap w-full items-stretch">
                                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-4/12 inline-flex bg-stone-200 rounded-l-lg px-3 py-2'>
                                                <option value="all">(CA)</option>
                                                <option value="sun">Sun</option>
                                                <option value="mon">Mon</option>
                                            </select>	
                                            <input type="text" placeholder="(778) 881 - 1132" className="w-8/12 inline-flex font-normal h-12 px-3 outline-0 text-sec rounded-r-lg bg-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                                        </div>
                                    </div>
                                </div>
                                <div className="md:flex md:space-x-2">
                                    ...
                                    <div className="md:w-4/6 md:mb-0 mb-2">
                                        <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Address</label>
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <input type="text" placeholder="Thilak" className="font-normal h-12 w-full px-3 outline-0 text-sec rounded-lg bg-stone-200 placeholder-black-800 hover:border-theme focus:border-theme"/>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div className="w-full space-y-2 mt-5">
                                <details className="py-2 rounded-lg">
                                    <summary className="font-semibold md:text-lg text-base">EMERGENCY CONTACT DETAILS</summary>
                                    <div className="mt-3">
                                    <div className="lg:flex lg:space-x-2 mb-4">
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Relation With You</label>
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='h-12 w-full px-3 outline-0 text-sec rounded-lg bg-stone-200 placeholder-gray-400 hover:border-theme focus:border-theme'>
                                    ...
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="phone_no" className="block mb-2 text-base font-semibold text-sec">Full Name</label>
                                        <div className="relative flex w-full flex-wrap items-stretch">
                                            <input type="text" placeholder="Krishnamoorthy" className="h-12 w-full px-3 outline-0 text-sec rounded-lg bg-stone-200 placeholder-gray-400 hover:border-theme focus:border-theme"/>
                                        </div>
                                    </div>
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Phone Number</label>
                                        <div className="relative flex flex-wrap w-full items-stretch">
                                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-4/12 inline-flex bg-stone-200 rounded-l-lg px-3 py-2'>
                                                <option value="all">(CA)</option>
                                                <option value="sun">Sun</option>
                                    ...
                                    <div className="lg:w-3/12 md:mb-0 mb-2">
                                        <label htmlFor="first_name" className="block mb-2 text-base font-semibold text-sec">Alternate Phone Number</label>
                                        <div className="relative flex flex-wrap w-full items-stretch">
                                            <select onChange={(event) => changeVisibility(event.target.value)} value={currentVisibility} className='w-4/12 inline-flex bg-stone-200 rounded-l-lg px-3 py-2'>
                                                <option value="all">(CA)</option>
                                                <option value="sun">Sun</option>
                                ...
                                <details className="py-2 rounded-lg">
                                    ...
                                    <div className="mt-3">
                                         <div className="border-2 border-stone-100 md:p-4 p-2 mb-3">
                                            <div className="md:flex justify-between">
                                                <div className="md:text-lg text-md text-theme font-semibold inline-flex"><svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="14.889" height="18.469" viewBox="0 0 14.889 18.469">
                                                ...
                                                <div className="card-point w-fit">
                                                    <b>Valid till : 02/05/2023</b><a href="#" className="inline-flex ml-4"><p className="rounded-full border-2 border-theme text-base font-bold text-theme mb-1.5 px-3 py-1 hover:bg-theme hover:text-white md:block hidden">Active</p></a>
                                                </div>
                                            </div>
                                            <div className="md:flex">
                                                <div className="md:w-3/12">
                                                    <p className="md:mb-2"><b>Subscription Amount :</b> 350 CAD</p>
                                                    <p><b>Plan for :</b> Signal Adult</p>
                                                </div>
                                                <div className="md:w-9/12">
                                                    <p className="md:mb-2"><b>Description : </b>Detail information about this plan. Example (Per Day usage limit 3 hours)</p>
                                                </div>
                                                
                                            </div>
                                            <div className="flex justify-end">
                                                <div className="card-point">                                                    
                                                    <a href="#" className="text-right flex-end"><p className=" w-fit rounded-full border-2 border-theme text-base font-bold text-theme mb-1.5 px-3 py-1 hover:bg-theme hover:text-white md:hidden block">Active</p></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table className="table-auto w-full responsive rounded-lg border-collapse md:text-base text-sm p-4 mt-4 mb-4">
                                        <thead>
                                            <tr className='text-center bg-neutral-200 p-8'>
                                                <th className='py-3 px-2 mb-4'>Holder Name</th>
                                                <th>Type</th>
                                                <th>Card Type</th>
                                        ...
                                        <tbody>
                                            <tr className='text-center'>
                                                ...
                                                <td>27/11/2027</td>
                                                <td>
                                                    <input type="checkbox" name="set1" id="set1" value="set1" checked={isChecked} onChange={handleOnChange} />
                                                </td>
                                            </tr>
                                            <tr className='text-center'>
                                                <td className='py-3 px-2'>Thilak Nirmala</td>
                                                ...
                                                <td>27/11/2027</td>
                                                <td>
                                                    <input type="checkbox" name="set2" id="set2" value="set2" checked={isChecked} onChange={handleOnChange} />
                                                </td>
                                            </tr>
                                        </tbody>
                                        </table>
        ...
        <div className="footer md:w-full md:fixed bottom-0  bg-sec text-white text-sm font-semibold py-2 text-center xl:block hidden">
