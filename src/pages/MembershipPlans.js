      ...
      <div className="dash wrapper flex items-stretch w-full h-screen bg-light">
        ...
        <nav id="sidebar" className={`h-full max-w-182 lg:max-w-260 w-full z-10 relative ${navbar ? "block w-full Fullmenu" : "md:w-14 w-0 overflow-hidden  Iconmenu"}`}>
          ...
          <li className="min-h-58">
            ...
            <li className="min-h-42">
              <NavLink to='/MembershipPlans' className="active leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
         ...
         <div id="content" className={`h-full relative w-full  ${navbar2 ? "Fullviews" : "Halfviews"}`}>
            <div className="p-4">
                <div className="container-fluid z-10">
                    <div className="flex flex-wrap items-center bg-white relative mb-3 lg:mb-2 shadow p-2">
                        <div className="flex items-center"> 
                            ...
                            <div className="title-set">
                                ...
                                <svg className="inline-flex md:mr-3 mr-1" xmlns="http://www.w3.org/2000/svg" width="16.838" height="18.103" viewBox="0 0 16.838 18.103">
                                    <g id="Group_3567" data-name="Group 3567" transform="translate(-4672 758.552)">
                                        <path id="Path_2222" data-name="Path 2222" d="M1412.427,499.485h4.369a.773.773,0,0,1,.869.865q0,2.493,0,4.986a.773.773,0,0,1-.858.858h-8.8a.779.779,0,0,1-.854-.847q0-2.513,0-5.026a.773.773,0,0,1,.843-.835Zm-2.06,4.59a1.652,1.652,0,0,1,.206.087c.214.125.424.256.636.385.116.07.255.168.361.044a.474.474,0,0,0,.053-.343,6.328,6.328,0,0,0-.171-.722.339.339,0,0,1,.124-.39,6.522,6.522,0,0,0,.553-.5.4.4,0,0,0,.113-.306c-.016-.071-.162-.144-.259-.16a6.343,6.343,0,0,0-.76-.07.346.346,0,0,1-.344-.252c-.095-.25-.189-.5-.308-.74-.043-.087-.156-.192-.237-.191a.356.356,0,0,0-.238.192,7.683,7.683,0,0,0-.32.779.29.29,0,0,1-.3.212c-.268.013-.536.032-.8.071-.091.014-.222.079-.245.15a.339.339,0,0,0,.112.264c.207.2.43.383.65.57a.293.293,0,0,1,.107.336c-.072.257-.124.52-.192.779-.033.125-.06.264.073.316a.454.454,0,0,0,.327-.035c.227-.114.438-.258.658-.387A2.141,2.141,0,0,1,1410.367,504.075Zm4.325.748c.429,0,.859,0,1.288,0,.222,0,.349-.121.35-.3s-.123-.3-.348-.3c-.141,0-.282,0-.423,0-.711,0-1.423,0-2.134,0-.247,0-.367.1-.368.3s.126.306.365.308C1413.846,504.827,1414.269,504.824,1414.692,504.823Zm0-3.359c.423,0,.846,0,1.268,0,.242,0,.371-.108.374-.3s-.133-.311-.384-.311q-1.248,0-2.5,0c-.256,0-.389.105-.392.3s.125.306.382.308C1413.856,501.466,1414.272,501.465,1414.688,501.464Zm-.008,1.68c.423,0,.846,0,1.268,0,.249,0,.386-.115.381-.312s-.135-.295-.376-.295q-1.258,0-2.517,0c-.255,0-.383.108-.379.31s.133.3.374.3C1413.848,503.146,1414.264,503.144,1414.68,503.144Z" transform="translate(3267.985 -1258.036)" fill="#ff6a00"/>
                                        <path id="Path_2223" data-name="Path 2223" d="M1463.068,841.28a13.73,13.73,0,0,1-2.759-.279.424.424,0,0,1-.4-.49c.071-.686.124-1.378.256-2.053a2.14,2.14,0,0,1,2.064-1.688c.5-.01.994,0,1.49,0a2.213,2.213,0,0,1,2.309,2.1c.053.527.119,1.052.181,1.578a.449.449,0,0,1-.389.555A13.407,13.407,0,0,1,1463.068,841.28Z" transform="translate(3217.353 -1581.729)" fill="#ff6a00"/>
                                        <path id="Path_2224" data-name="Path 2224" d="M1335.048,812a2.9,2.9,0,0,0-1.014,1.932c-.053.452-.11.9-.166,1.356,0,.026-.01.052-.019.1-.209.018-.422.045-.634.054a14.4,14.4,0,0,1-3.484-.235c-.4-.08-.525-.26-.473-.666.074-.578.123-1.159.214-1.734a2.114,2.114,0,0,1,1.949-1.838,14.244,14.244,0,0,1,2.13.022A1.992,1.992,0,0,1,1335.048,812Z" transform="translate(3342.754 -1556.945)" fill="#ff6a00"/>
                                        <path id="Path_2225" data-name="Path 2225" d="M1602.806,811.476a2.022,2.022,0,0,1,1.558-1.016,12.666,12.666,0,0,1,2.172,0,2.107,2.107,0,0,1,1.838,1.793c.1.629.172,1.261.246,1.893a.423.423,0,0,1-.368.512,13.488,13.488,0,0,1-4.165.208.617.617,0,0,1-.076-.02c-.044-.345-.1-.695-.129-1.047A3.163,3.163,0,0,0,1602.806,811.476Z" transform="translate(3080.214 -1556.439)" fill="#ff6a00"/>
                                        <path id="Path_2226" data-name="Path 2226" d="M1488.413,720.011a2.074,2.074,0,1,1-2.094,2.074A2.076,2.076,0,0,1,1488.413,720.011Z" transform="translate(3192.009 -1469.679)" fill="#ff6a00"/>
                                        <path id="Path_2227" data-name="Path 2227" d="M1358.155,694.009a2.075,2.075,0,1,1-.015,4.149,2.075,2.075,0,1,1,.015-4.149Z" transform="translate(3317.009 -1444.724)" fill="#ff6a00"/>
                                        <path id="Path_2228" data-name="Path 2228" d="M1616.694,696.083a2.078,2.078,0,0,1,4.156-.013,2.078,2.078,0,1,1-4.156.013Z" transform="translate(3066.886 -1444.725)" fill="#ff6a00"/>
                                    </g>
                                </svg>
                            <span className="font-bold inline-flex md:text-lg text-base">Membership Plans</span></h3>
                            </div>
                    ...
                    <div className="container-fluid">
                        <div className="bg-stone-100 md:p-4 p-2 mb-3">
                            <div className="md:flex justify-between mb-2">
                                <div className="md:text-lg text-base text-theme font-semibold inline-flex"><svg className="mr-2" xmlns="http://www.w3.org/2000/svg" width="14.889" height="18.469" viewBox="0 0 14.889 18.469">
                                ...
                                <div className="card-point w-fit">
                                    <a href="#" className=""><p className="rounded-full border-2 border-theme text-base font-bold text-theme mb-1.5 px-3 py-1 hover:bg-theme hover:text-white md:block hidden">Buy Membership</p></a>
                                </div>
                            </div>
                            <div className="md:flex">
                                <div className="md:w-3/12">
                                    <p className="mb-2"><b>Subscription Amount :</b> 350 CAD</p>
                                    <p className="md:mb-0 mb-2"><b>Plan for :</b> Signal Adult</p>
                                </div>
                                <div className="md:w-9/12">
                                    <p className="text-justify md:mb-0 mb-2"><b>Description : </b>Detail information about this plan. Example (Per Day usage limit 3 hours)
                                    Detail information about this plan. Example (Per Day usage limit 3 hours)Detail information about this plan. Example (Per Day usage limit 3 hours)</p>
                                </div>
                            </div>
                            <div className="flex justify-end md:hidden block">
                                <div className="card-point pt-2">                                                    
                                    <a href="#" className="text-right flex-end"><p className=" w-fit rounded-full border-2 border-theme text-base font-bold text-theme mb-1.5 px-3 py-1 hover:bg-theme hover:text-white ">Buy Membership</p></a>
                                </div>
                            </div>
                        </div>
                        <div className="bg-stone-100 md:p-4 p-2 mb-3">
            ...
            <div className="footer sm:fixed bottom-0 sm:w-full bg-sec py-2 xl:block hidden">
                <div className="flex text-white text-sm font-semibold  justify-center ">
        ...
        <div id="sidebar" className={`max-w-182 lg:max-w-xs w-full  ${navbar2 ? "block w-full Fullmenu sm:relative absolute sm:left-unset left-0" : "w-0 overflow-hidden "}`}>
          <div className="w-full min-w-320 max-w-xs md:relative">
