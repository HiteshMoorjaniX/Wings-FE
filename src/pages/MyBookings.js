      ...
      <div className="dash wrapper flex items-stretch w-full h-screen bg-light">
        ...
        {/* <nav className={`h-full  w-full z-10 ${navbar ? "md:w-14 w-0 Iconmenu overflow-hidden" : "md:w-14 w-0 overflow-hidden  Iconmenu"}`}> */}
          ...
          <ul className={`h-12 ${navbar ? "block" : "hidden"}`} className="sideNav b-5 text-white gap-y-2 bg-sec h-full fixed rounded-tr-3xl pt-4 flex flex-col gap-y-2">
            ...
            <li className="min-h-42">
            <NavLink to='/MyBookings' className="active leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
          ...
          <li className="min-h-42">
                <NavLink to='/MySchedules' className="leading-4 whitespace-nowrap overflow-hidden px-3 py-3 flex items-center w-full rounded-tr-full rounded-br-full hover:bg-theme focus:bg-theme">
                    <svg  opacity="0.5" className="mx-2" width="18" height="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,4h-1V3c0-0.6-0.4-1-1-1s-1,0.4-1,1v1H8V3c0-0.6-0.4-1-1-1S6,2.4,6,3v1H5C3.3,4,2,5.3,2,7v1h20V7C22,5.3,20.7,4,19,4z M2,19c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3v-9H2V19z M17,12c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S16.4,12,17,12z M17,16c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S16.4,16,17,16z M12,12c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S11.4,12,12,12z M12,16c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S11.4,16,12,16z M7,12c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S6.4,12,7,12z M7,16c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1-0.4-1-1S6.4,16,7,16z"  fill="#fff" /></svg>
            ...
            <div className="container-fluid">
              <div className="bg-white flex flex-wrap items-center relative mb-3 lg:mb-2 shadow p-2">                
                <div className="flex items-center"> 
                    ...
                    <span className="font-bold inline-flex md:text-lg text-base">My Bookings</span></h3>
                    </div>
                </div>                        
              </div>
            </div>
                  ...
                  <div className="p-2">                  
                    <div className="w-full space-y-2">
                        <details className="rounded-lg" open >
                            <summary className="relative"><span className="font-semibold md:text-lg text-base">Booking List</span>
                              <div className="absolute right-0 top-0 text-sm">
                                <span>4 Matches</span><span className="sm:inline-block hidden"> | 11h usage</span><span className="sm:inline-block hidden"> | $280.00</span>
                              </div>
                            </summary>
                            <div className="md:overflow-auto overflow-x-scroll">
                                ...
                                <tbody>
                                    <tr className='text-center'>
                                        <td className='py-5 px-2'>Court Rental | 23/01/2023 | 08:00 AM To 10:00 AM (2h)</td>
                                        <td>23/01/2023 | 08:00 AM</td>                                        
                                        <td>Self</td>
                                        <td>$70</td>
                                        <td>Card</td>
                                        <td><a href="#" className="paid rounded px-2 py-1">Paid</a></td>
                                        <td>                                                                                     
                                          <a href="#" className="bg-gray-200 text-gray-600 rounded px-2 py-1">
                                    ...
                                    <tr className='text-center'>
                                        <td className='py-5 px-2'>Court Rental | 23/01/2023 | 08:00 AM To 11:00 AM (3h)</td>
                                        <td>23/01/2023 | 08:00 AM</td>                                        
                                        <td>Admin</td>
                                        <td>$70</td>
                                        <td>Wallet</td>
                                    ...
                                    <tr className='text-center'>
                                        <td className='py-5 px-2'>Court Rental | 23/01/2023 | 08:00 AM To 12:00 PM (4h)</td>
                                        <td>23/01/2023 | 08:00 AM</td>                                        
                                        <td>Admin</td>
                                        <td>$70</td>
                                        <td>Cash</td>
                                        <td><a href="#" className="unpaid rounded px-2 py-1">UnPaid</a></td>
                                        <td>
                                          <a href="#" className="bg-gray-200 text-gray-600 rounded px-2 py-1">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="inline-flex " viewBox="0 0 16 16"> <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z"/> <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/> </svg>
                                          </a>
                                    ...
                                    <tr className='text-center'>
                                        <td className='py-5 px-2'>Court Rental | 23/01/2023 | 08:00 AM To 10:00 AM 0(2h)</td>
                                        <td>23/01/2023 | 08:00 AM</td>                                        
                                        <td>Admin</td>
                                        <td>$70</td>
                                        <td>E-Transfer</td>
                                        <td><a href="#" className="paid rounded px-2 py-1">Paid</a></td>
                                        <td>
                                          <a href="#" className="bg-gray-200 text-gray-600 rounded px-2 py-1" onClick={() => setCancelModal(true)}>
                                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="inline-flex " viewBox="0 0 16 16"> <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z"/> <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z"/> </svg>
                                          </a>
                                        </td>
                                    </tr>
